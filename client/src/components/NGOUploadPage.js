...
//     try {
//       const response = await axios.post('http://localhost:4567/cfg34/ngo/uploadStudentData', formData);
...
//         <div className="mb-3">
//           <label htmlFor="Grade12" className="form-label">12th Percentage</label>
//           <input
//             id="Grade12"
//             name="Grade12"
//             type="number"
...
//         <div className="mb-3">
//           <label htmlFor="yearOfScholarship" className="form-label">Year of Scholarship</label>
//           <input
